...
const EXEMPT_SETTINGS_ROUTES = ["/settings/account", "/settings/subscription"];
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        {/* Badge */}
        <div
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-700 mb-4"
        ...
        <h1
          className="text-xl font-800 tracking-tight mb-2"
...
export default function RouteGuard({ children }) {
  ...
  const { hasPermission, userPermissions, subscriptionAccess, isReadOnly } =
    useOrg();
  ...
  if (
    planRequirement &&
    subscriptionAccess &&
    !subscriptionAccess.capabilities.includes(planRequirement.capability)
  ) {
  ...
  // Always allow the subscription and account settings pages.
  if (EXEMPT_SETTINGS_ROUTES.includes(pathname)) return children;
